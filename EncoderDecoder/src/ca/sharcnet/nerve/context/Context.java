...
public class Context implements Serializable {
    ...
    public List<String> readFromDictionary(){ return new ArrayList<>(readFromDictionary); }
    public List<String> styles(){ return new ArrayList<>(styles); }
    public Map<String, TagInfo> tags(){ return new HashMap<>(tags); }
