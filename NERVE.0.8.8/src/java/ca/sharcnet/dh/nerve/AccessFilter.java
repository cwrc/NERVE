...
public class AccessFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) log("AccessFilter:DoBeforeProcessing");
        response.addHeader("Access-Control-Allow-Origin", "*");
    }

    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
        throws IOException, ServletException {
        if (debug) log("AccessFilter:DoAfterProcessing");
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) log("AccessFilter:doFilter()");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) System.out.println("AccessFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
        ...
        public String getParameter(String name) {
            if (debug) System.out.println("AccessFilter::getParameter(" + name + ") localParams = " + localParams);
            if (localParams == null)
        ...
        public String[] getParameterValues(String name) {
            if (debug) System.out.println("AccessFilter::getParameterValues(" + name + ") localParams = " + localParams);
            if (localParams == null)
        ...
        public Enumeration getParameterNames() {
            if (debug) System.out.println("AccessFilter::getParameterNames() localParams = " + localParams);
            if (localParams == null)
        ...
        public Map getParameterMap() {
            if (debug) System.out.println("AccessFilter::getParameterMap() localParams = " + localParams);
            if (localParams == null)
