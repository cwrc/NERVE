...
public class QueryOperationsTest implements HasStreams {
    ...
    @Test
    public void test_name() throws IOException, DocumentParseException{
    ...
    @Test
    public void test_hasClass_true() throws IOException, DocumentParseException {
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_hasClass_true_multiple_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_hasClass_true_multiple_2() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_hasClass_false_in_doc() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_hasClass_false_in_doc_multiple() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("d");
    ...
    @Test
    public void test_hasClass_false_not_in_doc() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_class() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_class_twice() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
        query.addClass("apple");
        query.addClass("apple");
    ...
    @Test
    public void test_removeClass() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_removeClass_multiple() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
    ...
    @Test
    public void test_removeClass_all() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query("*");
        query.removeClass();
        query = doc.query("*");
    ...
    @Test
    public void test_remove() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_remove_part() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        doc.query("a").detach();
     ...
     */
    @Test
    public void test_remove_multi() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    public void test_remove_multi_ex() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
     ...
     */
    @Test
    public void test_remove_refined() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_remove_extract() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        doc.query("#a").extract();
        assertEquals(0, doc.query("#a").size());
    ...
    @Test
    public void test_remove_extract_multi() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_attr() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_attr_empty_select() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    /* first element doesn't have attribute */
    @Test
    public void test_attr_null() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals("", doc.query("*").attr("data"));
    }

    @Test
    public void test_attr_set() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_attr_remove() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_children() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_intersect_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_intersect_empty() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_unique() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query1 = doc.query("b");
    ...
    @Test
    public void test_xor() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query1 = doc.query("b");
    ...
    @Test
    public void test_text_0() throws IOException, DocumentParseException{
    ...
    @Test
    public void test_text_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("text.xml"));
        assertEquals("beta", doc.query(".first > div").text());
    }

    @Test
    public void test_text_replace() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("text.xml"));
    ...
    @Test
    public void test_copy() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_copy_empty() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_copy_check_not_same() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query copy = doc.query("a").copy();
    ...
    @Test
    public void test_append_new_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_append_new_2() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_append_new_3() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query appendNew = doc.query(".third").appendNew("div");
    ...
    @Test
    public void test_append_new_4() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_append_new_5() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_prepend_new_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_prepend_new_2() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_prepend_new_3() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query prependNew = doc.query(".third").prependNew("div");
    ...
    @Test
    public void test_prepend_new_4() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_prepend_new_5() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
     ...
     */
    @Test
    public void test_replace_with_none() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
     ...
     */
    @Test
    public void test_replace_with_one() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
     ...
     */
//    @Test
//    public void test_replace_with_many() throws IOException, DocumentParseException{
//        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
...
//    }
     ...
     */
    @Test
    public void test_replace_with_many_rvalue() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        Query query = doc.query(".first");
    ...
    */
    @Test
    public void test_prepend_0() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    */
    @Test
    public void test_prepend_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        String before = doc.toString();
    ...
    */
    @Test
    public void test_prepend_2() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    */
    @Test
    public void test_prepend_3() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    */
    @Test
    public void test_prepend_5() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        String before = doc.toString();
    ...
    */
    @Test
    public void test_prepend_6() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void name_none() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals(null, doc.query("").name());
    }

    @Test
    public void name_one() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals("div", doc.query(".first").name());
    }

    @Test
    public void name_many() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals("c", doc.query(".middle").name());
    }

    @Test
    public void has_attr_true() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals(true, doc.query(".middle").hasAttr("class"));
    }

    @Test
    public void has_attr_false() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals(false, doc.query("root").hasAttr("class"));
    }

    @Test
    public void has_attr_empty() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    */
    @Test
    public void test_append_0() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        String before = doc.toString();
    ...
    */
    @Test
    public void test_append_1() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        String before = doc.toString();
    ...
    */
    @Test
    public void test_append_2() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    */
    @Test
    public void test_append_3() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    */
    @Test
    public void test_append_5() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        String before = doc.toString();
    ...
    */
    @Test
    public void test_append_6() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
    ...
    @Test
    public void test_last_empty_set() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals(null, doc.query("").last());
    }

    @Test
    public void test_first_empty_set() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
        assertEquals(null, doc.query("").first());
    }

    @Test
    public void test_text_empty_set() throws IOException, DocumentParseException{
        Document doc = DocumentLoader.documentFromStream(getResourceStream("multi.xml"));
