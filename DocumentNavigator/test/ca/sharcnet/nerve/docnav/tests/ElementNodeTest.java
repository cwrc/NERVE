...
public class ElementNodeTest {
    private final ElementNode eNode1;
    private final ElementNode root;
    private final ElementNode gen1[] = new ElementNode[3];
    private final ElementNode gen2[] = new ElementNode[9];

    public ElementNodeTest() {
