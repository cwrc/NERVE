...
let NameSource = require("../../lib/context");
...
class CWRCDialogModel extends AbstractModel{
    ...
    query(searchTerm, entityValue){
        let tagInfo = this.context.getTagInfo(entityValue.tagName, NameSource.NAME);
        ...
        this.dialogs[tagInfo.getDialogMethod()]({
            ...
            success: (result) => {
                console.log(result);
                let values = new EntityValues(entityValue.entity, result.name, result.uri, entityValue.tagName, "");
    ...
    queryEntity(entityValue){
        this.query(entityValue.entity, entityValue);
    }
    ...
    queryPerson(term){
        this.dialogs.popSearchPerson({
            ...
            success: (result) => {
                ...
                let values = new EntityValues(term, lemma);
