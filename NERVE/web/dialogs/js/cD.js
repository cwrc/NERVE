...
// * bug if source RNG schema has an implied required element.  It needs to be
// wrapped in an interleave element otherwise the qualifier (e.g. oneOrMore,
// zeroOrMore, optional, or implied "required") is not represented in the model
// and the model in not serialized to XML properly - don't know how to quickly
// fix so we changed the schema - 2015-02-24
// e.g.
// <element ..>
...
$(function () {
    ...
    (function () {
        ...
        search.processCWRCSearch = function (queryString, page) {
            console.log("search.processCWRCSearch");
            var perPage = 100;
...
//          search.isDataSelected(false); // setting to false here breaks modal dismiss
        ...
        search.selectResult = function (result, event) {
        ...
        search.runCustomAction = function (custom, event) {
            search.scrapeResult();
