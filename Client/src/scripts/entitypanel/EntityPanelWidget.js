...
//        $(this.getElement()).attr("contenteditable", "true");   
    ...
    async load(){
        ...
        await this.cwrcDialogs.registerEntitySource(require("../cwrcdialogs/viaf"));
        await this.cwrcDialogs.registerEntitySource(require("../cwrcdialogs/dbpedia"));
        await this.cwrcDialogs.registerEntitySource(require("../cwrcdialogs/wiki"));
        await this.cwrcDialogs.registerEntitySource(require("../cwrcdialogs/getty"));
        await this.cwrcDialogs.registerEntitySource(require("../cwrcdialogs/geonames"));        
